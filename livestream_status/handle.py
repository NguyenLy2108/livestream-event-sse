...
class LivestreamStatusService():  
    ...
    def livestreams_of_currentday(self):  
        ...
        start_time = current_time.replace(hour=0, minute=0, second=0, microsecond=0).astimezone(pytz.utc)
        end_time = current_time.replace(hour=23, minute=59, second=59, microsecond=999999).astimezone(pytz.utc)       
